...
export interface WAVEBarInterface extends utils.Interface {
  functions: {
...
export type ShareRevenueEvent = TypedEvent<
  [BigNumber],
  ShareRevenueEventObject
>;
...
export interface WAVEBar extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WAVEBarInterface;
  ...
  functions: {
    ...
    leave(
      _shareOfveWAVE: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
