...
import type {
  IStaticATokenLM,
  IStaticATokenLMInterface,
} from "../../BatchRelayerLibrary.sol/IStaticATokenLM";
...
export class IStaticATokenLM__factory {
  ...
  static createInterface(): IStaticATokenLMInterface {
    return new utils.Interface(_abi) as IStaticATokenLMInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IStaticATokenLM {
    return new Contract(address, _abi, signerOrProvider) as IStaticATokenLM;
  }
}
