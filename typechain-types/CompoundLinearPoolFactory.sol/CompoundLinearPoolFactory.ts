...
export interface CompoundLinearPoolFactoryInterface extends utils.Interface {
  functions: {
    "create(string,string,address,address,uint256,uint256)": FunctionFragment;
...
export interface CompoundLinearPoolFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CompoundLinearPoolFactoryInterface;
