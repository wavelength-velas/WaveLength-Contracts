...
contract RewarderMock is IRewarder {
    ...
    function onWAVEReward(
        ...
        uint256 waveAmount,
        uint256 newLpAmount
    ) external override onlyMCV {
        uint256 pendingReward = waveAmount.mul(rewardMultiplier) / REWARD_TOKEN_DIVISOR;
    ...
    function pendingTokens(
        ...
        _rewardAmounts[0] = waveAmount.mul(rewardMultiplier) / REWARD_TOKEN_DIVISOR;
        return (_rewardTokens, _rewardAmounts);
    }

    modifier onlyMCV() {
        require(msg.sender == masterChef, "Only MCV can call this function.");
        _;
    }
}
