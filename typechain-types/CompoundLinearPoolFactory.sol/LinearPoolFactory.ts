...
export interface LinearPoolFactoryInterface extends utils.Interface {
  functions: {
...
export interface LinearPoolFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LinearPoolFactoryInterface;
