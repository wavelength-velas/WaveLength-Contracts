...
export interface StablePhantomPoolFactoryInterface extends utils.Interface {
  functions: {
    "create(string,string,address[],uint256,address[],uint256[],uint256)": FunctionFragment;
...
export interface StablePhantomPoolFactory extends BaseContract {
