...
export declare namespace WAVEMasterChef {
...
export interface WAVEMasterChefInterface extends utils.Interface {
  functions: {
    ...
    "pendingWAVE(uint256,address)": FunctionFragment;
...
export interface WAVEMasterChef extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WAVEMasterChefInterface;
  ...
  callStatic: {
    ...
    updatePool(
      _pid: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<WAVEMasterChef.PoolInfoStructOutput>;
