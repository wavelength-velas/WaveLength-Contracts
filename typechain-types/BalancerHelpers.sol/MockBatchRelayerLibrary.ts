...
export interface MockBatchRelayerLibraryInterface extends utils.Interface {
  functions: {
    ...
    "getChainedReferenceValue(uint256)": FunctionFragment;
    ...
    "setChainedReferenceValue(uint256,uint256)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "batchSwap"
      | "exitPool"
      | "getChainedReferenceValue"
      | "getEntrypoint"
      | "getVault"
      | "joinPool"
      | "manageUserBalance"
      | "setChainedReferenceValue"
      | "setRelayerApproval"
      | "swap"
      | "vaultPermit"
      | "vaultPermitDAI"
  ...
  encodeFunctionData(
    functionFragment: "getChainedReferenceValue",
  ...
  encodeFunctionData(
    functionFragment: "setChainedReferenceValue",
  ...
  events: {
    "ChainedReferenceValueRead(uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "ChainedReferenceValueRead"): EventFragment;
}

export interface ChainedReferenceValueReadEventObject {
  value: BigNumber;
}
export type ChainedReferenceValueReadEvent = TypedEvent<
  [BigNumber],
  ChainedReferenceValueReadEventObject
>;

export type ChainedReferenceValueReadEventFilter =
  TypedEventFilter<ChainedReferenceValueReadEvent>;

export interface MockBatchRelayerLibrary extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockBatchRelayerLibraryInterface;
  ...
  filters: {
    "ChainedReferenceValueRead(uint256)"(
      value?: null
    ): ChainedReferenceValueReadEventFilter;
    ChainedReferenceValueRead(
      value?: null
    ): ChainedReferenceValueReadEventFilter;
  };
