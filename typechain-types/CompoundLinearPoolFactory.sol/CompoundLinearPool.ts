...
export interface CompoundLinearPoolInterface extends utils.Interface {
  functions: {
...
export interface CompoundLinearPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CompoundLinearPoolInterface;
