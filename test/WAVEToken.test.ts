...
import { WAVEToken } from "../typechain-types/WAVEMasterChef.sol/WAVEToken";
import { SignerWithAddress } from "@nomiclabs/hardhat-ethers/signers"
import {deployToken} from "../scripts/tokenomicsDeployer";
...
describe("BeethovenX token tests", () => {
  ...
  beforeEach(async function () {
    beets = await deployContract("WAVEToken", [])
